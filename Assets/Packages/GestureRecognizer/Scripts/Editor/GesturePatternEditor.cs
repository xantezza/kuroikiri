...
namespace GestureRecognizer
{
    ...
    public class GesturePatternEditor : Editor
    {
        ...
        private SerializedProperty useOrder;
        ...
        private int FindNear(SerializedProperty array, Vector2 pos)
        {
            int nearIndex = 0;
        ...
        private int CalcAboveLineIndex(SerializedProperty points, Vector2 pos, float lineDist)
        {
        ...
        private const int RoundFactor = 16;
        ...
        private Vector2 NegY1(Vector2 v)
        {
        ...
        private void DrawGrid(Rect rect, int divs)
        {
        ...
        private void DrawDots(Vector2 p1, Vector2 p2, float dist)
        {
        ...
        private void HandlesDrawLineStrong(Vector2 v1, Vector2 v2)
        {
